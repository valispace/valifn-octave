...
LABEL org.opencontainers.image.description "Octave docker image to be used by ValiFN"
...
RUN apt-get --quiet update && apt-get --quiet --no-install-recommends --fix-broken --assume-yes install octave
